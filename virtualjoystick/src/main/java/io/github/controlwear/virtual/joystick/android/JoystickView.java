    ...
    */
    ...
    public JoystickView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mButtonSizeRatio = styledAttributes.getFraction(R.styleable.JoystickView_JV_buttonSizeRatio, 1, 1, 0.45f);
            mBackgroundSizeRatio = styledAttributes.getFraction(R.styleable.JoystickView_JV_backgroundSizeRatio, 1, 1, 0.55f);
    ...
    protected void onSizeChanged(int w, int h, int oldW, int oldH) {
        ...
        mBorderRadius = (int) (d / 2 * mBackgroundSizeRatio-0.35*mButtonRadius);
